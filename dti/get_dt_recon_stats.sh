...
meas=fa
mri_segstats --seg ${b}/wmparc2diff.mgz --snr --robust 2.5 --ctab $FREESURFER_HOME/FreeSurferColorLUT.txt --i ${b}/${meas}.nii.gz --sum ${d}/${meas}.stats

meas=ivc
mri_segstats --seg ${b}/wmparc2diff.mgz --snr --robust 2.5 --ctab $FREESURFER_HOME/FreeSurferColorLUT.txt --i ${b}/${meas}.nii.gz --sum ${d}/${meas}.stats

meas=radialdiff
mri_segstats --seg ${b}/wmparc2diff.mgz --snr --mul 1000 --robust 2.5 --ctab $FREESURFER_HOME/FreeSurferColorLUT.txt --i ${b}/${meas}.nii.gz --sum ${d}/${meas}.stats

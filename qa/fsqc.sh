...
do
	echo "<tr>"																						>> index.html
	echo "<td><a href=\"file:"$sub".lh.lat.hr.tif\"><img src=\""$sub".lh.lat.hr.tif\"></a></td>"	>> index.html
	echo "<td><a href=\"file:"$sub".lh.med.hr.tif\"><img src=\""$sub".lh.med.hr.tif\"></a></td>"	>> index.html
	echo "<td><a href=\"file:"$sub".rh.lat.hr.tif\"><img src=\""$sub".rh.lat.hr.tif\"></a></td>"	>> index.html
	echo "<td><a href=\"file:"$sub".rh.med.hr.tif\"><img src=\""$sub".rh.med.hr.tif\"></a></td>"	>> index.html
	echo "</tr>"																					>> index.html
	echo "<tr>"																						>> index.html

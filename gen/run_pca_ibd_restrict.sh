...
# PCA
plink --threads 16 --bfile _working/prune_${1} --pca 20 --out ${1}_pca_prune_ibd20v1


#plink --bfile $1 --keep $2 --make-bed --out _working/no_prune_${1}
#plink --threads 16 --bfile _working/no_prune_${1} --pca 20 --out ${1}_pca_prune_ibd20v1

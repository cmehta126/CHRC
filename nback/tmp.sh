...
TCSH_AFNI=afni.${SID}.${TASK}_tmp.tcsh
PWD_TASK=${SID}.${TASK}_tmp


[ -f $FN_NIFTI ] && echo "File is there."
...
#module load tcsh/6.19.00-foss-2016a
#module load Python/2.7.11-foss-2016a
source ~/.bashrc
...
#module load tcsh/6.19.00-foss-2016a
# $TCSH_AFNI #|& tee output.tmp.txt #> output.${TCSH_AFNI}
